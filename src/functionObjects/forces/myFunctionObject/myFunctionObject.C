...
void Foam::functionObjects::myFunctionObject::setCoordinateSystem
(
...
Foam::volVectorField& Foam::functionObjects::myFunctionObject::force()
{
...
Foam::volVectorField& Foam::functionObjects::myFunctionObject::moment()
{
...
void Foam::functionObjects::myFunctionObject::initialise()
{
    if (initialised_)
    {
        return;
...
void Foam::functionObjects::myFunctionObject::reset()
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::myFunctionObject::mu() const
{
...
Foam::tmp<Foam::volScalarField> Foam::functionObjects::myFunctionObject::rho() const
{
    if (rhoName_ == "rhoInf")
    {
...
Foam::functionObjects::myFunctionObject::rho(const label patchi) const
{
    if (rhoName_ == "rhoInf")
    {
...
Foam::scalar Foam::functionObjects::myFunctionObject::rho(const volScalarField& p) const
{
...
void Foam::functionObjects::myFunctionObject::addToPatchFields
(
    const label patchi,
...
void Foam::functionObjects::myFunctionObject::addToInternalField
(
...
void Foam::functionObjects::myFunctionObject::createIntegratedDataFiles()
{
    if (!forceFilePtr_)
    {
...
void Foam::functionObjects::myFunctionObject::writeIntegratedDataFileHeader
(
    const word& header,
    OFstream& os
) const
...
void Foam::functionObjects::myFunctionObject::writeIntegratedDataFiles()
{
    const auto& coordSys = coordSysPtr_();
...
void Foam::functionObjects::myFunctionObject::writeIntegratedDataFile
(
    const vector& pres,
    const vector& vis,
...
void Foam::functionObjects::myFunctionObject::logIntegratedData
(
...
Foam::functionObjects::myFunctionObject::myFunctionObject
(
    const word& name,
    const Time& runTime,
    const dictionary& dict,
...
bool Foam::functionObjects::myFunctionObject::read(const dictionary& dict)
{
...
void Foam::functionObjects::myFunctionObject::calcForcesMoments()
{
    initialise();
    ...
    else
    {
        ...
        for (const label patchi : patchIDs_)
        {
            ...
            const vectorField fV(fP.size(), vector(0, 0, 0)); 
...
Foam::vector Foam::functionObjects::myFunctionObject::forceEff() const
{
    return sumPatchForcesP_ + sumPatchForcesV_ + sumInternalForces_;
}


Foam::vector Foam::functionObjects::myFunctionObject::momentEff() const
{
    return sumPatchMomentsP_ + sumPatchMomentsV_ + sumInternalMoments_;
}


bool Foam::functionObjects::myFunctionObject::execute()
{
    calcForcesMoments();
    ...
    logIntegratedData("myFunctionObject", localFp, localFv, localFi);
...
bool Foam::functionObjects::myFunctionObject::write()
{
    if (writeToFile())
    {
