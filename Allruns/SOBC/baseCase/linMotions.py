...
#with open('../lin90U.dat', 'a') as f:
#    f.write(f"{lam/Lpp} {eta1} {eta2} {eta3} {eta4} {eta5} {eta6}\n")

print(lam/Lpp, eta1, eta2, eta3, eta4, eta5, eta6)
...
axs[1,0].set_ylabel('$η_4/kζ$')
axs[1,1].set_ylabel('$η_5/kζ$')
axs[1,2].set_ylabel('$η_6/kζ$')
